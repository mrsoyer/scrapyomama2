...
return  spinnage($text);
 ...
 $age = $_REQUEST['age'];
  ...
  $proxy = explode(":",$_REQUEST['proxy']);
	...
	$from_name="lili";
	$from_address="01@domaine-name-01.ovh";                                              $sender_line=__LINE__;
	$reply_name="01@domaine-name-01.ovh";
	$reply_address="01@domaine-name-01.ovh";
	$reply_address="01@domaine-name-01.ovh";
	$error_delivery_name="lili";
	$error_delivery_address="01@domaine-name-01.ovh";
	$to_name=explode("@",$to);
	$to_name=$to_name[0];
	...
	$email_message->localhost="domaine-name-01.ovh";
	...
	$email_message->smtp_http_proxy_host_name="188.214.8.84";
	/* Change this variable if you need to connect to SMTP server via an HTTP proxy */
	$email_message->smtp_http_proxy_host_port="80";
	...
	*/
	...
	$email_message->smtp_user="01@domaine-name-01.ovh";
